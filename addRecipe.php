...
<body>
   <form name= "addRecipe" action = "process.php" method="post" autocomplete="off">
        ...
        <p>Title: <input type="text" name="title" style="margin-left:45px; width:90%" required/></p>
        <p>Description: <input type="text" name= "description" style="height:50;width:90%" required/></p>
        <p>Ingredients: <input type="text" name= "ingredients" style="height:250px;width:90%" required/></p>
        <p>Instructions: <input type="text" name= "instructions" style="height:250px;width:90%"required/></p>
